  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle 600px at ${smoothMousePosition.x}% ${smoothMousePosition.y}%, transparent 0%, transparent 10%, rgba(0,0,0,${vignetteOpacity}) 100%)`,
          backdropFilter: `blur(${vignetteOpacity * 4}px)`,
